...
def get_curve_params(E, r, k):
    ...
    print "after second extension"
    
    R.<y> = twist_field[]
    extension_field.<w> = twist_field.extension(x^2 - nu)
    assert extension_field.order() == twist_field.order() ^ 2
...
def print_all_data(p, r, k, nonresidue, curve, twisted_curve, G1, G2):
    print "base field: ", p 
    print "base field bitlength: ", p.nbits()
    print "group order: ", r
    print "group order bitlength: ", r.nbits()
    print "embedding degree: ", k
    print "extension non-residue: ", nonresidue
    print "curve A: ", curve.a4()
    print "curve B: ", curve.a6()
    print "twisted curve A: ", twisted_curve.a4()
    print "twisted curve B: ", twisted_curve.a6()
    print "generator of first source group: ", G1
    print "generator of second source group: ", G2



k = 4 # embedding degree
